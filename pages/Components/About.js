...
function About() {
  return (
    <div className='container mx-auto  sm:my-15 sm:py-15  px-6' id='about'>
      <div className='text-center text-blue-500  my-2 sm:mb-10 font-samibold text-2xl font-Quicksand mt-16'>About Us</div>
      ...
      <div className='flex items-center main_about'>
        <div className='main_about_image w-[42%] text-center relative'> <img src='./About.png' alt='about us is img not loding..' /></div>
